...
--
-- Host: localhost:3306
-- Generation Time: Apr 13, 2019 at 05:21 PM
...
INSERT INTO `login` (`id`, `username`, `password`, `offer`) VALUES
(31, 'hi', '$2y$10$cEJBgPo8DgK57vZYvIbKgeiLTuSCQTKWsmXd4ujj9gxq2QswhdYJm', ''),
(30, 'root', '$2y$10$fnjV4rKjERyP9hzGzIJA5umHwBTJ9arJkQxOnpJejoAP6PP4mJYhq', ''),
(37, 'test2', '$2y$10$somO/M/cXP0Zh90kxZN4qO1Z/lGbolg/3bz1Cz6ecK0dsLU6wi2QG', 'GOLD Level'),
(36, 'ioanna', '$2y$10$u8szRL10FWrW36/4PgkjguL7i7AKD9zSRA5b/mkKosyfY.48/oexS', 'FAMILY Pack'),
(35, 'test', '$2y$10$dUUm03N2.Nx/QPcC2j2UZuzZ5BTIN2ItQcDomJIo/nheOqdc54uDG', 'PLATINUM Level'),
(34, '123', '$2y$10$nso92G3C69thCsb4PM3uAOE0FPBflTgCv6y9krQ.B7Dz0.a.5WkLe', 'SILVER Level'),
(33, 'jj', '$2y$10$ZKB8E3NzCILnfKYlHIQS8OW8w0OR7mWy5bVOooL.Agonfudt3.4k2', ''),
(32, 'tt', '$2y$10$suiANBFpANfX26RfeLggi.rvLlOEtWdzrUzXbuhRk.4pTPU55aEsi', ''),
(38, 'test3', '$2y$10$bEjKAg.BpzqjYzyinQT6M.Zm9FTbLfnrcYtR1gSDMi5N00WMxau8e', 'PLATINUM Level'),
(39, 'test4', '$2y$10$O7njf5SIkcNUhsCV1M1YR.wXG6xBwpjTmY8mnV/nkRoL/Cv4yFTES', 'PLATINUM Level'),
(40, 'test5', '$2y$10$/xozDo5Dyl5sjoLq/NXD7.B9wLYRdwPA9xhWxKVCNI6qWakmBAyTG', 'PLATINUM Level'),
(41, 'test6', '$2y$10$1UiacalHHD4onGV7U5NncuH4KtGf3KXWlHDx8BocWeDPVvmM90P2C', 'SILVER Level'),
(42, 'test8', '$2y$10$i9moRo0SpuD6XJHaMAEVJuFP8z9cPflnijw7e/Gp1oUxmSWyoeGSm', 'SILVER Level'),
(43, 'test99', '$2y$10$ZdtuUrsnUtGezJXAXHX75.IkRzX5RsHpXl8EwsiRHRYi4kd08UPYG', 'SILVER Level'),
(44, '1234', '$2y$10$OMsQuH5b/iiXD8b1up/P0eb06XgvI3bve0PYxPQJ.4ptXSu0DraT.', 'FAMILY Pack'),
(45, 'papap3', '$2y$10$Ni6077xXlCfFPj91UnEUSOEAWIqm75/nKp95UWVqzwEhDUYhPKptS', 'FAMILY Pack'),
(46, 'test1', '$2y$10$ZHuy.cdJRw4sTaKfEy9gx.RIhnA2ada3RDLEGEgR/Tx8/0.qgYeJi', 'PLATINUM Level'),
(47, '12345678', '$2y$10$E.lzq81SS.AN8Q3MfIo93OWRmeUk/36qiXze0Tw0l2N8dlAFc22DO', 'GOLD Level'),
(48, 'test12', '$2y$10$ZQgBhJzqljkMHbqvHx1ACOIeefYXK8tq.k5.EbFNsd/WdpRukImsW', 'GOLD Level'),
(49, 'SIoannou3', '$2y$10$nAsj9d1xP642yXJSauKZPuctpDJZ86ako7CdTnKgg0Id7dSSbxmcy', 'GOLD Level');
...
INSERT INTO `playlist` (`track_id`, `artist`, `album`, `description`, `name`, `genre`, `image`, `thumb`, `sample`) VALUES
...
(43, 17, 'test', 'test test test test test test test test test test test test test test test test test test test test', 1),
(32, 14, 'root', 'hi', 5);
...
--
ALTER TABLE `reviews`
  MODIFY `review_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=91;
--
